...
//		container : 'abc',
        ...
        uploader.bind('Error', function (up, err) {
          ...
          console.error("Error: " + err.code + ", Message: " + err.message + (err.file ? ", File: " + err.file.name : "") + "");
        ...
        uploader.bind('FilesAdded', function (up, files) {
          ...
          if (options.auto_upload || iAttrs.plAutoUpload == "true") {
            uploader.start();
          }
        ...
        uploader.bind('UploadProgress', function (up, file) {
          ...
          /*
          @TODO
            Fileupload von einem Element in der Liste merken (dual-binding)
              -> eine offene und eine interne liste
              -> wenn aus offener liste was gelöscht wird...
            Maximal Anzahl an Dateien für dieses Element
           */
